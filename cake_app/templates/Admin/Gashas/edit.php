      ...
      <div class="row">
        <div class="col-lg-2 col-md-2 col-sm-12">
          <div class="form-group">
            ...
            <?= $this->Form->control('start_date', ['type' => 'text', 'id' => 'start_date-datepicker', 'required' => false, 'error' => false, 'class' => 'form-control form-control-sm rounded-0 ', 'label' => false, 'data-toggle' => 'datetimepicker', 'data-target' => '#start_date-datepicker', 'value' => $this->formatDate($gasha->start_date, 'yyyy-MM-dd')]); ?>
          </div>
        </div>
        <div class="col-lg-2 col-md-2 col-sm-12">
          <div class="form-group">
            ...
            <?= $this->Form->control('end_date', ['type' => 'text', 'id' => 'end_date-datepicker', 'required' => false, 'error' => false, 'class' => 'form-control form-control-sm rounded-0 ', 'label' => false, 'data-toggle' => 'datetimepicker', 'data-target' => '#end_date-datepicker', 'value' => $this->formatDate($gasha->end_date, 'yyyy-MM-dd')]); ?>
          </div>
        </div>
        <div class="col-lg-8 col-md-8 col-sm-12">
          <div class="form-group">
            <?= $this->element('Parts/label', ['field' => 'title', 'label' => 'ガシャタイトル', 'require' => true, 'class' => 'item-label col-form-label col-form-label-sm']); ?>
            <?= $this->Form->control('title', ['type' => 'text', 'class' => 'form-control form-control-sm rounded-0 ', 'label' => false, 'required' => false, 'error' => false]); ?>
          </div>
        </div>
        <div class="col-lg-2 col-md-2 col-sm-12">
          <div class="form-group">
            ...
            <div class="input number">
              <div class="input-group input-group-sm">
                <?= $this->Form->text('ssr_rate', ['type' => 'number', 'id' => 'ssr_rate', 'class' => 'form-control form-control-sm rounded-0', 'label' => false, 'min' => '0', 'max' => '100', 'step' => '1', 'required' => false, 'error' => false]); ?>
        ...
        <div class="col-lg-2 col-md-2 col-sm-12">
          <div class="form-group">
            ...
            <div class="input number">
              <div class="input-group input-group-sm">
                <?= $this->Form->text('sr_rate', ['type' => 'number', 'id' => 'sr_rate', 'class' => 'form-control form-control-sm rounded-0', 'label' => false, 'min' => '0', 'max' => '100', 'step' => '1', 'required' => false, 'error' => false]); ?>
                <div class="input-group-append"><span class="input-group-text rounded-0">%</span></div>
              </div>
            </div>
          </div>
