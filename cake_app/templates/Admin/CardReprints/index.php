      ...
      <div class="row">
        <div class="col-auto">
          <div class="btn-group" role="group">
            ...
            <?php } ?>
            <a class="btn btn-sm btn-flat btn-outline-secondary d-none d-lg-inline" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#card_reprints-search-form-modal">検索</a>
            ...
            <div class="dropdown-menu" aria-labelledby="sp-action-link">
              ...
              <?php } ?>
              <a class="dropdown-item" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#card_reprints-search-form-modal">検索</a>
              <?php if (AuthUtils::hasRole($this->getRequest(), ['action' => ACTION_CSV_EXPORT])) { ?>
        ...
        <div class="col">
          <?= $this->Form->create($search_form, ['type' => 'get', 'id' => 'card_reprints-freeword-search-form']) ?>
            <div class="freeword-search input-group input-group-sm d-none d-xl-flex">
              ...
              <?= $this->Form->text('search_snippet', ['id' => 'card_reprints-freeword-search-snippet', 'class' => 'form-control form-control-sm rounded-0 border-start-0 border-end-0', 'style' => 'flex-grow: 0; flex-basis: 200px;', 'placeholder' => 'フリーワード']) ?>
              ...
              <tr>
                ...
                <td class="actions">
                  <?php if (AuthUtils::hasRole($this->getRequest(), ['action' => ACTION_VIEW])) { ?>
                    <?= $this->Html->link('<i title="詳細" class="far fa-list-alt me-1"></i>', ['action' => ACTION_VIEW, $card_reprint->id], ['escape' => false]) ?>
                  <?php } ?>
                  <?php if (AuthUtils::hasRole($this->getRequest(), ['action' => ACTION_EDIT])) { ?>
                    <?= $this->Html->link('<i title="編集" class="fas fa-pen me-1"></i>', ['action' => ACTION_EDIT, $card_reprint->id], ['escape' => false]) ?>
                  <?php } ?>
