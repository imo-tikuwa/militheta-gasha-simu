      ...
      <div class="modal-body">
        <?= $this->Form->create(null, ['type' => 'get', 'id' => 'cards-search-form']) ?>
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12">
              <div class="form-group">
                <?= $this->Form->control('rarity', ['type' => 'select', 'options' => ["" => "　"] + _code('Codes.Cards.rarity'), 'class' => 'form-control select2', 'label' => 'レアリティ', 'value' => @$params['rarity']]); ?>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12 col-sm-12">
              <div class="form-group">
                <?= $this->Form->control('type', ['type' => 'select', 'options' => ["" => "　"] + _code('Codes.Cards.type'), 'class' => 'form-control select2', 'label' => 'タイプ', 'value' => @$params['type']]); ?>
              </div>
            </div>
          </div>
          <div class="row">
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12">
              <div class="form-group">
                <?= $this->Form->control('gasha_include', ['type' => 'select', 'options' => ["" => "　"] + _code('Codes.Cards.gasha_include'), 'class' => 'form-control select2', 'label' => 'ガシャ対象？', 'value' => @$params['gasha_include']]); ?>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12 col-sm-12">
              <div class="form-group">
                <?= $this->Form->control('limited', ['type' => 'select', 'options' => ["" => "　"] + _code('Codes.Cards.limited'), 'class' => 'form-control select2', 'label' => '限定？', 'value' => @$params['limited']]); ?>
              </div>
            </div>
          </div>
          <div class="row">
