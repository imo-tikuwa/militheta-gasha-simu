...
class GashasFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'start_date' => ['type' => 'date', 'length' => null, 'null' => true, 'default' => null, 'comment' => 'ガシャ開始日', 'precision' => null],
        'end_date' => ['type' => 'date', 'length' => null, 'null' => true, 'default' => null, 'comment' => 'ガシャ終了日', 'precision' => null],
        'title' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => 'ガシャタイトル', 'precision' => null],
        'ssr_rate' => ['type' => 'integer', 'length' => null, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => 'SSRレート', 'precision' => null, 'autoIncrement' => null],
        'sr_rate' => ['type' => 'integer', 'length' => null, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => 'SRレート', 'precision' => null, 'autoIncrement' => null],
